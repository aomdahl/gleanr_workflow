...
mkdir -p ${BD}/scratch/manuscript_reviews/permute_testing/assess_test_seed31_100_byROW/
...
#--num_columns=4,11,23 --output ${BD}/scratch/manuscript_reviews/permute_testing/assess_test_seed31_100_byROW/ \
#--ref_analysis ${BD}/custom_l1_factorization/results/panUKBB_complete_41K_final/panUKBB_complete_41K_final_final_dat.RData

mkdir -p ${BD}/scratch/manuscript_reviews/permute_testing/assess_test_seed31_200_byROW/
...
--gene_sets ${BD}/custom_l1_factorization/manuscript_analyses/PanUKBB_analysis/analysis/platelet_diseases_gene_lists.txt \
--num_columns=4,11,23 --output ${BD}/scratch/manuscript_reviews/permute_testing/assess_test_seed31_200_byROW/ \
--ref_analysis ${BD}/custom_l1_factorization/results/panUKBB_complete_41K_final/panUKBB_complete_41K_final_final_dat.RData
