#!/bin/bash
#SBATCH -J GLEANER_full_permute23
#SBATCH --time=3:00:00
...
Rscript src/gleanr_permute.R  --gwas_effects ${P}/panUKBB_complete_clumped_r2-0.2.beta.tsv --uncertainty  ${P}/panUKBB_complete_clumped_r2-0.2.se.tsv --trait_names ${P}/panUKBB_complete.trait_list.tsv \
        ...
        --outdir /scratch16/abattle4/ashton/snp_networks/scratch/manuscript_reviews/permute_testing/panUKBB_41K_final/seed23_ --fixed_first --nfactors 136 --sample_sd  ${P}/sample_sd_report.tsv --WLgamma Strimmer \
