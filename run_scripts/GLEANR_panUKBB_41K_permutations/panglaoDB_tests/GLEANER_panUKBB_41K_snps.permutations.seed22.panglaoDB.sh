#!/bin/bash
#SBATCH --job-name=seed22_panglao
#SBATCH --time=3:0:0
...
mkdir -p ${BD}/scratch/manuscript_reviews/permute_testing/panglaoDB/assess_test_seed22_100/
...
--gene_sets ${PG_GENES} \
--num_columns=4,11,23 --output ${BD}/scratch/manuscript_reviews/permute_testing/panglaoDB/assess_test_seed22_100/ \
--ref_analysis ${BD}/custom_l1_factorization/results/panUKBB_complete_41K_final/panUKBB_complete_41K_final_final_dat.RData -t

#mkdir -p ${BD}/scratch/manuscript_reviews/permute_testing/panglaoDB/assess_test_seed22_200/
...
#--gene_sets ${PG_GENES} \
#--num_columns=4,11,23 --output ${BD}/scratch/manuscript_reviews/permute_testing/panglaoDB/assess_test_seed22_200/ \
